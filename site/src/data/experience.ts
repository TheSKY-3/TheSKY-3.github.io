...
export const experience = {
  ...
  period: "2026.05 - 至今",
  intro:
    "在出行平台的运营中心做经营分析：从 1015 万条订单里回答「补贴给谁、资源压哪」的渠道问题，把重复出现的分析固化成 AI Skill，把三方资金结算口径写成研发可对照的标准。",
  stats: [
  ...
  highlights: [
    ...
    },
    {
      title: "出租车抽佣口径与财务对账",
      problem:
        "司机、车企、平台三方资金结算链路长——车租抵扣、双侧平台抽佣、路桥费回补、同日/跨日调账，口径不一致账就对不平。",
      actions: [
        "基于 8,242 条司机钱包对账记录，梳理完整的三方资金结算链路",
        "设计 21 项标准结算字段、边界规则与验证案例，协同研发推进系统实现",
      ],
      outcome: "结算口径成为研发实现的对照标准，支持业务复核与审计追溯。",
      tags: ["财务对账", "口径设计", "跨职能协作"],
