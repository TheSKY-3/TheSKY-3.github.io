...
export const experience = {
  ...
  workflowCaption:
    "财务对账工作流：三方结算链路与 21 项标准结算字段共同构成研发实现的对照标准。",
  highlights: [
    {
      title: "渠道经营与调价分析",
    ...
    },
    {
      title: "出租车抽佣口径与财务对账",
      problem:
        "司机、车企、平台三方资金结算链路长——车租抵扣、双侧平台抽佣、路桥费回补、同日/跨日调账，口径不一致账就对不平；每月人工对账要花掉约一天。",
      actions: [
        "梳理完整的三方资金结算链路，明确字段、边界规则与异常处理口径",
        "设计 21 项标准结算字段、边界规则与验证案例，协同研发推进系统实现",
        "将对账流水线固化为 ruqi-reconciliation Skill 并封装为本地程序：输入双方结算 xlsx，自动匹配、填列并生成或更新对账表",
      ],
      outcome:
        "结算口径成为研发实现的对照标准；部门财务的月度对账从约 1 天压缩到约 10 分钟，历史月份可一键核验，重复键或缺字段自动中止、不写坏源文件。",
      tags: ["财务对账", "口径设计", "本地程序"],
